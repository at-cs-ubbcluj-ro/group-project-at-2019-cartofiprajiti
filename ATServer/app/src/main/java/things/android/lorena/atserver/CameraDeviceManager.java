...
/**
 * reference: https://github.com/androidthings/doorbell
 */
public class CameraDeviceManager {
    private static final String TAG = CameraDeviceManager.class.getSimpleName();
    ...
    public static synchronized CameraDeviceManager getInstance() {
        if(INSTANCE == null) {
            INSTANCE = new CameraDeviceManager();
        }
        return INSTANCE;
    }
